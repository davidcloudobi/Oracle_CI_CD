[![Continuous Integration and Deployment](https://github.com/davidcloudobi/Oracle_CI_CD/actions/workflows/ci-cd.yaml/badge.svg)](https://github.com/davidcloudobi/Oracle_CI_CD/actions/workflows/ci-cd.yaml)
